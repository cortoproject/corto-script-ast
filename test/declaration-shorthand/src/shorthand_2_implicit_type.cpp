...
void test_shorthand_2_implicit_type_full_id(
...
void test_shorthand_2_implicit_type_full_nested_id(
    test_shorthand_2_implicit_type _this)
{
...
void test_shorthand_2_implicit_type_id(
    test_shorthand_2_implicit_type _this)
{
    char *result, *input = "hello: 10, 20";
    char *expect =
...
void test_shorthand_2_implicit_type_nested_id(
    test_shorthand_2_implicit_type _this)
{
    char *result, *input = "hello/world: 10, 20";
    char *expect =
