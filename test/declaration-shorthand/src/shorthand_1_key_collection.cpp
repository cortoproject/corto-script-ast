...
void test_shorthand_1_key_collection_named_type_full_id(
    test_shorthand_1_key_collection _this)
{
...
void test_shorthand_1_key_collection_named_type_full_nested_id(
    test_shorthand_1_key_collection _this)
{
...
void test_shorthand_1_key_collection_named_type_id(
    test_shorthand_1_key_collection _this)
{
    char *result, *input = "foo hello: the_key:[10]";
    char *expect =
...
void test_shorthand_1_key_collection_named_type_nested_id(
    test_shorthand_1_key_collection _this)
{
    char *result, *input = "foo hello/world: the_key:[10]";
    char *expect =
...
void test_shorthand_1_key_collection_named_type_root_id(
    test_shorthand_1_key_collection _this)
{
