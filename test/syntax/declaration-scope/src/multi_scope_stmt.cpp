...
void test_multi_scope_stmt_anonymous_type_full_nested_id(
    test_multi_scope_stmt _this)
{
    char *result, *input = "foo(bar) /hello/world, /world/hello { stmt; }";
    char *expect =
        "statements:\n"
        "|   Declaration\n"
        "|   |   type: StorageInitializer\n"
...
void test_multi_scope_stmt_implicit_type_full_nested_id(
    test_multi_scope_stmt _this)
{
    char *result, *input = "hello/world, world/hello { stmt; }";
    char *expect =
        "statements:\n"
        "|   Declaration\n"
        "|   |   id: DeclarationIdentifier\n"
...
void test_multi_scope_stmt_named_type_full_nested_id(
    test_multi_scope_stmt _this)
{
    char *result, *input = "foo hello/world, world/hello { stmt; }";
    char *expect =
        "statements:\n"
        "|   Declaration\n"
        "|   |   type: Identifier\n"
